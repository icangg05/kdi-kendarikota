...
use App\Filament\AdminPPID\Resources\InformasiSertaMertaResource\Pages;
use App\Filament\AdminPPID\Resources\InformasiSertaMertaResource\RelationManagers;
...
class InformasiSertaMertaResource extends Resource
{
  ...
  public static function getEloquentQuery(): Builder
  {
    ...
    $query->with('user')->where('kategori', 'informasi-serta-merta');
  ...
  {
    $query = static::getModel()::where('kategori', 'informasi-serta-merta');
  ...
  {
    return [
      'index' => Pages\ListInformasiSertaMertas::route('/'),
      'create' => Pages\CreateInformasiSertaMerta::route('/create'),
      'edit' => Pages\EditInformasiSertaMerta::route('/{record}/edit'),
    ];
  }
}
